...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            # self.epsilon = math.cos(0.0033*self.t)
            # self.epsilon = 0.99 * self.t
            # self.epsilon = math.cos(0.01*self.t)
            # self.alpha = math.exp(-(0.01 * self.t))
            # self.epsilon = 0.99 * self.epsilon
            # self.epsilon = math.cos(0.008 * self.t)
            # self.epsilon = 0.99 * self.epsilon
            # self.epsilon = math.cos(0.003 * self.t)
            # self.epsilon = 0.995 * self.epsilon
            # self.epsilon = 1 + math.cos(math.pi/2 + 0.0035 * self.t)
            # self.alpha = 0.992 * self.alpha
            self.epsilon = 0.991 * self.epsilon
